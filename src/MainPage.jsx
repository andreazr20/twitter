        ...
        <div>
            ...
            <div className='bg-black h-20 ml-[23%] w-full gap-60 fixed'>
                <div className=' flex pt-12 mt-1'>
                    ...
                    <input type="text" placeholder='              Search' className='mb-3 w-[22vw] h-12 bg-zinc-800  rounded-3xl mt-[-1.5%] ml-[2vw]' />
                </div>
            ...
            <div className='border border-slate-700 border-b-[0.1vw] max-w-[66vw] border-r-[0.1vw]'>
                <div className='flex bg-black'>
                    ...
                    <div className='flex ml-[10vw]'>
                        <button onClick={handleSubmit} className='fondo-btn text-white ml-[7vw] w-[5vw] border rounded-3xl mt-[3vw]  mb-[1vw] '><strong>Post</strong></button>
