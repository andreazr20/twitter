...
// para borrar tweets
  ...
  const handleDeleteTweet = (uuidv4) => {
  ...
  return (
    <div>
        ...
        <div className='bg-black w-[23%] h-full fixed'>
            ...
            <button className='fondo-btn text-white w-[55%] ml-[29%] mt-[10%] border rounded-3xl h-12'><strong>Post</strong></button>
    ...
    <div className='flex bg-black'>
        ...
        <div className='flex ml-[10vw]'>
            ...
            <h2 className='text-blue-400 ml-[-28.5vw] mt-[11vw] h-[4vw] pt-4 pl-[21vw] border border-t-gray-500 border-b-gray-500 border-l-gray-500 border-r-gray-500  fixed w-[66vw] bg-black'>Show 35 post</h2>
                            ...
                            <ul id="lista" style={{ display: listaVisible ? 'block' : 'none' }} className='w-[25vw] border border-gray-500 h-[27vw] rounded-2xl fixed ml-[5vw] p-[1vw]'>
                                <li className=' bg-black'>
                                    <div className='flex mb-5'>
                                        <svg className='w-[1vw] fill-red-500 mr-3' onClick={() => handleDeleteTweet(post.uuidv4)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M135.2 17.7C140.6 6.8 151.7 0 163.8 0L284.2 0c12.1 0 23.2 6.8 28.6 17.7L320 32l96 0c17.7 0 32 14.3 32 32s-14.3 32-32 32L32 96C14.3 96 0 81.7 0 64S14.3 32 32 32l96 0 7.2-14.3zM32 128l384 0 0 320c0 35.3-28.7 64-64 64L96 512c-35.3 0-64-28.7-64-64l0-320zm96 64c-8.8 0-16 7.2-16 16l0 224c0 8.8 7.2 16 16 16s16-7.2 16-16l0-224c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16l0 224c0 8.8 7.2 16 16 16s16-7.2 16-16l0-224c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16l0 224c0 8.8 7.2 16 16 16s16-7.2 16-16l0-224c0-8.8-7.2-16-16-16z"/></svg>
                                        <button className='text-red-500'><strong>Delete</strong></button>
                                    </div>
                                </li>
                                <li>
                                    <div className='flex mb-5'>
    ...
    <div className='float-right bg-black  mt-[-7vw] w-[34vw] ml-[66vw] h-[50vw] fixed'>
